...
jmeter -n -t $JMETER_HOME/v2_api/cloudfront_css_endpoint_dev.jmx -p $JMETER_HOME/config/user.properties -J csv_data=$JMETER_HOME/config/data_dev.csv -l /data/data.csv &